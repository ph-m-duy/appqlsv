...
export default class MoTerm extends React.Component {
    ...
    selectMoMonth = (_term, _givemoney, _addmoney, _olaymoney, _addlearnmoney) => {
        var options = {
            method: 'POST',
   ...
   checkMonthSent = () =>{
    ...
    inputMoney = () => {
        ...
        this.state.term = this.props.termmonth;
        return (
            <div>
                ...
                <input type="button"  value="Xác nhận"  onClick={() => this.selectMoMonth(this.state.term, this.state.givemoney, this.state.addmoney, this.state.olaymoney, this.state.addlearnmoney)}/>
                <input type="button" onClick={() => this.props.backmonth()} value="Quay lại" />
            </div >
        )
    }
